...
class GameSetting private constructor() {
    ...
    companion object {
        private val propertyNameToField: Map<String, KMutableProperty<*>> = mapOf(
            ...
            "maxFps" to ::maxFps,
            "worldThreads" to ::worldThreads
        )

        var worldWidth: Int = 1000; private set
        var worldHeight: Int = 500; private set
...
//        var neighbourCellsToLive: List<Int> = listOf(2, 3, 4, 5, 6, 7); private set
